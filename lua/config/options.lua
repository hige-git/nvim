...
o.showtabline = 2					                        -- always shows tabs
...
o.splitbelow = true					                      -- force all horizintal splits to go below current window
...
o.foldmethod = "indent"                           -- to only apply fold to same indent with zM and zR
